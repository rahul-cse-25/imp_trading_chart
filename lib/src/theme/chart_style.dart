...
import 'package:imp_trading_chart/imp_trading_chart.dart' show LineChartStyle, CurrentPriceIndicatorStyle, RippleAnimationStyle, PriceLabelStyle, TimeLabelStyle, AxisStyle, ChartLayout, CrosshairStyle;
import 'package:imp_trading_chart/src/theme/trading_colors.dart' show TradingColors;
...
class ChartStyle {
    ...
    ChartStyle({
        ...
        currentPriceStyle = currentPriceStyle ?? const CurrentPriceIndicatorStyle(),
    ...
    factory ChartStyle.trading({
        ...
        return ChartStyle(
            ...
            layout: ChartLayout(chartDataPadding: EdgeInsets.fromLTRB(10, 30, 10, 10))
        );
    }
