...
class Candle {
    ...
    Color get fillColor => isBullish ? TradingColors.bullishFill : TradingColors.bearishFill;
    ...
    factory Candle.fromMap(Map<String, dynamic> map) {
        return Candle(
            ...
            volume: map.containsKey('volume') ? parseDoubleValue(map['volume']) : null
        );
    }
...
List<Candle> parseCandlesFromPayload(Map<String, dynamic> payload) {
    ...
    return list
        .map((e) => (e as Map<String, dynamic>).toCandle())
        .toList();
}
